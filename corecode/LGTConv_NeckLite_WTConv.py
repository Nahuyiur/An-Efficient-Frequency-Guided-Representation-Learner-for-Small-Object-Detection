...
import math
from .WTConv_original import WTConv2d_original
...
class LGTConvNeckLite_WT(nn.Module):
    """
    轻量化LGT Neck模块
    ...
    def __init__(self, c1, c2=None, kernel_size=5, num_orientations=2, num_scales=1):
        ...
        # 高频特征处理：优先用WTConv_original（要求c1==c2），否则回退DWConv以保持通道/参数稳定
        if c1 == c2:
            self.high_conv = WTConv2d_original(c1, c2, kernel_size=3, stride=1)
