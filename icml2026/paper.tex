...
\begin{table}[ht]
    ...
    \begin{tabular}{@{}l p{0.68\columnwidth}@{}} 
        ...
        \midrule
        CPU              & {\fontsize{6.5pt}{7.5pt}\selectfont Intel(R) Xeon(R) Gold 5218R CPU @ 2.10GHz} \\
        GPU              & {\fontsize{6.5pt}{7.5pt}\selectfont NVIDIA A100-PCIE-40GB} \\
        VRAM             & {\fontsize{6.5pt}{7.5pt}\selectfont 40 GB} \\
        RAM              & {\fontsize{6.5pt}{7.5pt}\selectfont 46 GB} \\
        Operating System & {\fontsize{6.5pt}{7.5pt}\selectfont Rocky Linux 8.5 (Green Obsidian)} \\
        Language         & {\fontsize{6.5pt}{7.5pt}\selectfont Python 3.10.14} \\
        Frame            & {\fontsize{6.5pt}{7.5pt}\selectfont PyTorch 2.1.0} \\
        CUDA Version     & {\fontsize{6.5pt}{7.5pt}\selectfont 12.6} \\
        \bottomrule
    \end{tabular}
\end{table}
%这个表格需要调整大小/格式
